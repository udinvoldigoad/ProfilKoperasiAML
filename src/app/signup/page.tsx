...
export const metadata: Metadata = {
  ...
  description: "Informasi pendaftaran anggota Koperasi Agro Mulyo Lestari."
};
      ...
      <section className="container-page flex min-h-[600px] items-center py-16">
        <Card className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-on-surface-variant">
            Untuk menjaga validitas data, akun anggota dibuat oleh admin Koperasi Agro Mulyo Lestari. Silakan hubungi admin melalui kontak resmi.
          </p>
